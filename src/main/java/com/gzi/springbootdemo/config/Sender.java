...
public class Sender {
    ...
    public void sendDirectQueue() {
        ...
        user.setName("dwd");
        System.err.println("【sendDirectQueue已发送消息】");
    ...
    public void sendTopic() {
        ...
        System.err.println("【sendTopic已发送消息】");
        // 第一个参数：TopicExchange名字
        // 第二个参数：Route-Key
        // 第三个参数：要发送的内容
        this.amqpTemplate.convertAndSend(RabbitMQConfig.TOPIC_EXCHANGE, "dwd.message", user1 );
        this.amqpTemplate.convertAndSend(RabbitMQConfig.TOPIC_EXCHANGE, "dwd.dwd", user2);
    }
    ...
    public void sendFanout() {
        ...
        user.setUserId("123456");
        user.setName("dwd");
        System.err.println("【sendFanout已发送消息】");
        // 注意， 这里的第2个参数为空。
